...
export const metadata: Metadata = {
  ...
  description: 'Discover adapters, watchers, role managers, middlewares, and dispatchers for Casbin across 11 programming languages',
};
          ...
          <div className="relative max-w-7xl mx-auto px-6 py-16 md:py-24">
            <div className="text-center mb-12 space-y-6">
              ...
              <p className="text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
                A comprehensive collection of <strong>adapters</strong>, <strong>middlewares</strong>, <strong>watchers</strong>, 
                and more — supporting <strong>11 programming languages</strong>
              </p>
