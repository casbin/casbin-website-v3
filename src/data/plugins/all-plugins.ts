...
export const allPlugins: Plugin[] = [
  {
    ...
    "description": "For [.CSV (Comma-Separated Values)](https://en.wikipedia.org/wiki/Comma-separated_values) files",
    "tags": [
      "Go",
      "Adapter"
    ],
  ...
  },
  {
    ...
    "description": "For [.CSV (Comma-Separated Values)](https://en.wikipedia.org/wiki/Comma-separated_values) files with policy subset loading support",
    "tags": [
      "Go",
      "Adapter"
    ],
  ...
  },
  {
    ...
    "description": "MySQL, PostgreSQL, SQL Server, SQLite3 are supported in `master` branch and Oracle is supported in `oracle` branch by `database/sql`",
  ...
  },
  {
    ...
    "description": "MySQL, PostgreSQL, TiDB, SQLite, SQL Server, Oracle are supported by [Xorm](https://github.com/go-xorm/xorm/)",
    "image": "/images/ecosystem/SQL.png",
    "tags": [
      "Go",
      "Adapter"
  ...
  },
  {
    ...
    "description": "MySQL, PostgreSQL, Sqlite3, SQL Server are supported by [GORM](https://github.com/go-gorm/gorm)",
    "image": "/images/ecosystem/SQL.png",
    "tags": [
      "Go",
      "Adapter"
  ...
  },
  {
    ...
    "description": "MySQL, MariaDB, PostgreSQL, SQLite, Gremlin-based graph databases are supported by [ent ORM](https://entgo.io/)",
    "image": "/images/ecosystem/SQL.png",
    "tags": [
      "Go",
      "Adapter"
  ...
  },
  {
    ...
    "description": "MySQL, PostgreSQL, Sqlite3 are supported by [Beego ORM](https://beego.wiki/docs/mvc/model/overview/)",
    "image": "/images/ecosystem/SQL.png",
    "tags": [
      "Go",
      "Adapter"
  ...
  },
  {
    ...
    "description": "MySQL, PostgreSQL, SQLite, Oracle are supported by [SQLX](https://github.com/jmoiron/sqlx)",
    "image": "/images/ecosystem/SQL.png",
    "tags": [
      "Go",
      "Adapter"
  ...
  },
  {
    ...
    "description": "MySQL, PostgreSQL, SQL Server, SQLite3 are supported in `master` branch and Oracle is supported in `oracle` branch by [sqlx](https://github.com/jmoiron/sqlx)",
    "image": "/images/ecosystem/SQL.png",
    "tags": [
      "Go",
      "Adapter"
  ...
  },
  {
    ...
    "description": "MySQL, SQLite, PostgreSQL, Oracle, SQL Server are supported by [GoFrame ORM](https://github.com/gogf/gf/tree/master/contrib/drivers)",
    "image": "/images/ecosystem/SQL.png",
    "tags": [
      "Go",
      "Adapter"
  ...
  },
  {
    ...
    "description": "MySQL, SQLite, PostgreSQL, Oracle, SQL Server are supported by [GoFrame ORM](https://goframe.org/pages/viewpage.action?pageId=1114686)",
    "image": "/images/ecosystem/SQL.png",
    "tags": [
      "Go",
      "Adapter"
  ...
  },
  {
    ...
    "description": "MySQL, SQLite, PostgreSQL, SQL Server are supported by [Bun ORM](https://bun.uptrace.dev/guide/drivers.html)",
    "tags": [
      "Go",
      "Adapter"
    ],
  ...
  },
  {
    ...
    "description": "For [MongoDB](https://www.mongodb.com) based on [MongoDB Go Driver](https://github.com/mongodb/mongo-go-driver)",
  ...
  },
  {
    ...
    "description": "For [Minio](https://github.com/minio/minio) and [Amazon S3](https://aws.amazon.com/s3/)",
  ...
  },
  {
    ...
    "description": "Adapter based on [Go Cloud Dev Kit](https://gocloud.dev/) that supports: Amazon DynamoDB, Azure CosmosDB, GCP Firestore, MongoDB, In-Memory",
  ...
  },
  {
    ...
    "description": "For [Microsoft Azure Cosmos DB](https://docs.microsoft.com/en-us/azure/cosmos-db/introduction)",
  ...
  {
    "title": "[GCP Cloud Spanner Adapter](https://github.com/flowerinthenight/casbin-spanner-adapter)",
  ...
  {
    "title": "[String Adapter (built-in)](https://github.com/casbin/node-casbin/blob/master/src/persist/stringAdapter.ts)",
    "description": "For String",
    "image": "/images/ecosystem/string.png",
    "tags": [
      "Node.js",
  ...
  },
  {
    ...
    "description": "MySQL, PostgreSQL, SQLite, Microsoft SQL Server are supported by [Sequelize](https://github.com/sequelize/sequelize)",
    "image": "/images/ecosystem/SQL.png",
    "tags": [
      "Node.js",
      "Adapter"
  ...
  },
  {
    ...
    "description": "MySQL, PostgreSQL, MariaDB, SQLite, MS SQL Server, Oracle, WebSQL, MongoDB are supported by [TypeORM](https://github.com/typeorm/typeorm)",
    "image": "/images/ecosystem/SQL.png",
    "tags": [
      "Node.js",
      "Adapter"
  ...
  },
  {
    ...
    "description": "MySQL, PostgreSQL, MariaDB, SQLite, MS SQL Server, AWS Aurora, Azure SQL are supported by [Prisma](https://www.prisma.io/)",
    "image": "/images/ecosystem/SQL.png",
    "tags": [
      "Node.js",
      "Adapter"
  ...
  },
  {
    ...
    "description": "PostgreSQL, MySQL, SQLite, Turso, Neon, PlanetScale, Vercel Postgres, Xata are supported by [Drizzle ORM](https://orm.drizzle.team/)",
    "image": "/images/ecosystem/SQL.png",
    "tags": [
      "Node.js",
      "Adapter"
  ...
  },
  {
    ...
    "description": "MSSQL, MySQL, PostgreSQL, SQLite3, Oracle are supported by [Knex.js](https://knexjs.org/)",
    "image": "/images/ecosystem/SQL.png",
    "tags": [
      "Node.js",
      "Adapter"
  ...
  },
  {
    ...
    "description": "MSSQL, MySQL, PostgreSQL, SQLite3, Oracle are supported by [Objection.js](https://vincit.github.io/objection.js/)",
    "image": "/images/ecosystem/SQL.png",
    "tags": [
      "Node.js",
      "Adapter"
  ...
  },
  {
    ...
    "description": "MongoDB, MySQL, MariaDB, PostgreSQL, SQLite are supported by [MikroORM](https://mikro-orm.io/)",
    "tags": [
      "Node.js",
      "Adapter"
    ],
  ...
  },
  {
    ...
    "description": "PostgreSQL adapter with advanced policy subset loading support and improved performances built with [node-postgres](https://node-postgres.com/).",
    "tags": [
      "Node.js",
      "Adapter"
    ],
  ...
  {
    "title": "[Mongoose Adapter (No-Transaction)](https://github.com/minhducck/casbin-mongoose-adapter)",
    "description": "MongoDB is supported by [Mongoose](https://mongoosejs.com/)",
    "tags": [
      "Node.js",
      "Adapter"
  ...
  },
  {
    ...
    "description": "PostgreSQL, MariaDB, MySQL, Oracle, SQLite, IBM DB2, Microsoft SQL Server, Firebird, ODBC are supported by [Django ORM](https://docs.djangoproject.com/en/3.0/ref/databases/)",
    "image": "/images/ecosystem/SQL.png",
    "tags": [
      "Python",
      "Adapter"
  ...
  },
  {
    ...
    "description": "PostgreSQL, MySQL, SQLite, Microsoft SQL Server, Firebird, Sybase, MAX DB, pyfirebirdsql are supported by [SQLObject](http://www.sqlobject.org/index.html)",
    "image": "/images/ecosystem/SQL.png",
    "tags": [
      "Python",
      "Adapter"
  ...
  },
  {
    ...
    "description": "PostgreSQL, MySQL, SQLite, Oracle, Microsoft SQL Server, Firebird, Sybase are supported by [SQLAlchemy](https://www.sqlalchemy.org/)",
    "image": "/images/ecosystem/SQL.png",
    "tags": [
      "Python",
      "Adapter"
  ...
  {
    "title": "[Async SQLAlchemy Adapter](https://github.com/officialpycasbin/async-sqlalchemy-adapter)",
    "description": "PostgreSQL, MySQL, SQLite, Oracle, Microsoft SQL Server, Firebird, Sybase are supported by [SQLAlchemy](https://www.sqlalchemy.org/)",
    "image": "/images/ecosystem/SQL.png",
    "tags": [
      "Python",
  ...
  {
    "title": "[Async Databases Adapter](https://github.com/officialpycasbin/casbin-databases-adapter)",
    "description": "PostgreSQL, MySQL, SQLite, Oracle, Microsoft SQL Server, Firebird, Sybase are supported by [Databases](https://www.encode.io/databases/)",
    "image": "/images/ecosystem/SQL.png",
    "tags": [
      "Python",
      "Adapter"
  ...
  },
  {
    ...
    "description": "MySQL, PostgreSQL, SQLite, Oracle, CockroachDB are supported by [Pony ORM](https://ponyorm.org/)",
    "image": "/images/ecosystem/SQL.png",
    "tags": [
      "Python",
      "Adapter"
  ...
  },
  {
    ...
    "description": "PostgreSQL (>=9.4), MySQL, MariaDB, and SQLite are supported by [Tortoise ORM](https://tortoise.github.io/databases.html)",
    "image": "/images/ecosystem/postgreSQL.png",
    "tags": [
      "Python",
      "Adapter"
  ...
  },
  {
    ...
    "description": "PostgreSQL, MySQL, SQLite are supported by [Ormar](https://github.com/collerek/ormar/)",
    "image": "/images/ecosystem/SQL.png",
    "tags": [
      "Python",
      "Adapter"
  ...
  {
    "title": "[SQLModel Adapter](https://github.com/shepilov-vladislav/async-casbin-sqlmodel-adapter)",
    "description": "PostgreSQL, MySQL, SQLite are supported by [SQLModel](https://github.com/tiangolo/sqlmodel)",
    "image": "/images/ecosystem/SQL.png",
    "tags": [
      "Python",
      "Adapter"
  ...
  },
  {
    ...
    "description": "MySQL, Oracle, PostgreSQL, DB2, Sybase, SQL Server are supported by [JDBC](https://docs.oracle.com/cd/E19226-01/820-7688/gawms/index.html)",
  ...
  },
  {
    ...
    "description": "Oracle, DB2, SQL Server, Sybase, MySQL, PostgreSQL are supported by [Hibernate](http://www.hibernate.org/)",
    "image": "/images/ecosystem/SQL.png",
    "tags": [
      "Java",
      "Adapter"
  ...
  },
  {
    ...
    "description": "MySQL, Oracle, PostgreSQL, DB2, Sybase, SQL Server (the same as JDBC) are supported by [MyBatis 3](https://mybatis.org/mybatis-3/)",
  ...
  },
  {
    ...
    "description": "MySQL, Oracle, PostgreSQL, SQLite are supported by [Hutool](https://github.com/looly/hutool)",
    "image": "/images/ecosystem/SQL.png",
    "tags": [
      "Java",
      "Adapter"
  ...
  },
  {
    ...
    "description": "MongoDB is supported by [mongodb-driver-sync](https://mongodb.github.io/mongo-java-driver/)",
    "image": "/images/ecosystem/monogoDB.png",
    "tags": [
      "Java",
      "Adapter"
  ...
  },
  {
    ...
    "description": "MySQL, PostgreSQL, SQLite, Microsoft SQL Server are supported by [techone/database](https://github.com/techoner/database)",
    "image": "/images/ecosystem/SQL.png",
    "tags": [
      "Php",
      "Adapter"
  ...
  },
  {
    ...
    "description": "MySQL, PostgreSQL, SQLite, Oracle, IBM DB2, Microsoft SQL Server, Other PDO Driver are supported by [zend-db](https://docs.zendframework.com/zend-db/)",
    "image": "/images/ecosystem/SQL.png",
    "tags": [
      "Php",
      "Adapter"
  ...
  },
  {
    ...
    "description": "Powerful PHP database abstraction layer ([DBAL](https://github.com/doctrine/dbal)) with many features for database schema introspection and management.",
  ...
  },
  {
    ...
    "description": "[Medoo](https://github.com/catfan/Medoo) is a lightweight PHP Database Framework to Accelerate Development, supports all SQL databases, including `MySQL`, `MSSQL`, `SQLite`, `MariaDB`, `PostgreSQL`, `Sybase`, `Oracle` and more.",
    "image": "/images/ecosystem/SQL.png",
    "tags": [
      "Php",
      "Adapter"
  ...
  },
  {
    ...
    "description": "MySQL, PostgreSQL, Oracle, IBM DB2, Microsoft SQL Server, PDO, etc. are supported by [laminas-db](https://github.com/laminas/laminas-db)",
    "image": "/images/ecosystem/SQL.png",
    "tags": [
      "Php",
      "Adapter"
  ...
  {
    "title": "[Zend-db Adapter](https://github.com/php-casbin/zend-db-adapter)",
    "description": "MySQL, PostgreSQL, Oracle, IBM DB2, Microsoft SQL Server, PDO, etc. are supported by [zend-db](https://github.com/zendframework/zend-db)",
    "image": "/images/ecosystem/SQL.png",
    "tags": [
      "Php",
      "Adapter"
  ...
  },
  {
    ...
    "description": "MySQL, PostgreSQL, SQLite, Oracle, Microsoft SQL Server, MongoDB are supported by [ThinkORM](https://github.com/top-think/think-orm)",
    "image": "/images/ecosystem/SQL.png",
    "tags": [
      "Php",
      "Adapter"
  ...
  },
  {
    ...
    "description": "MySQL, PostgreSQL, SQLite, Microsoft SQL Server, Oracle, DB2, etc. are supported by [Entity Framework 6](https://docs.microsoft.com/en-us/ef/ef6/)",
    "image": "/images/ecosystem/SQL.png",
    "tags": [
      ".NET",
      "Adapter"
  ...
  },
  {
    ...
    "description": "MySQL, PostgreSQL, SQLite, Microsoft SQL Server, Oracle, DB2, etc. are supported by [Entity Framework Core](https://docs.microsoft.com/en-us/ef/core/)",
    "image": "/images/ecosystem/SQL.png",
    "tags": [
      ".NET",
      "Adapter"
  ...
  },
  {
    ...
    "description": "[MySQL, PostgreSQL, SQLite, Microsoft SQL Server, Oracle, Access, Firebird, Sybase, etc.](https://github.com/linq2db/linq2db/blob/master/Tests/Base/TestProvName.cs) are supported by [linq2db](https://github.com/linq2db/linq2db)",
    "image": "/images/ecosystem/SQL.png",
    "tags": [
      ".NET",
      "Adapter"
  ...
  },
  {
    ...
    "description": "MySQL, PostgreSQL, SQLite, Microsoft SQL Server, Oracle, etc. are supported by [SqlSugar](https://github.com/donet5/SqlSugar)",
    "image": "/images/ecosystem/SQL.png",
    "tags": [
      ".NET",
      "Adapter"
  ...
  },
  {
    ...
    "description": "[SQLite, PostgreSQL, MySQL](https://github.com/diesel-rs/diesel/blob/master/guide_drafts/backend_installation.md) are supported by [Diesel](http://diesel.rs/)",
    "image": "/images/ecosystem/SQL.png",
    "tags": [
      "Rust",
      "Adapter"
  ...
  },
  {
    ...
    "description": "PostgreSQL, MySQL are supported by [Sqlx](https://github.com/launchbadge/sqlx) with fully asynchronous operation",
    "image": "/images/ecosystem/SQL.png",
    "tags": [
      "Rust",
      "Adapter"
  ...
  },
  {
    ...
    "description": "PostgreSQL, MySQL, SQLite are supported by [SeaORM](https://github.com/SeaQL/sea-orm) with fully asynchronous operation",
    "image": "/images/ecosystem/SQL.png",
    "tags": [
      "Rust",
      "Adapter"
  ...
  },
  {
    ...
    "description": "MySQL, PostgreSQL, SQLite, SQL Server, MariaDB, TiDB, CockroachDB, Oracle are supported by [Rbatis](https://github.com/rbatis/rbatis)",
    "image": "/images/ecosystem/SQL.png",
    "tags": [
      "Rust",
      "Adapter"
  ...
  },
  {
    ...
    "description": "[ADO, Amalgalite, IBM_DB, JDBC, MySQL, Mysql2, ODBC, Oracle, PostgreSQL, SQLAnywhere, SQLite3, and TinyTDS](http://sequel.jeremyevans.net/) are supported by [Sequel](http://sequel.jeremyevans.net/)",
    "image": "/images/ecosystem/SQL.png",
    "tags": [
      "Ruby",
      "Adapter"
  ...
  {
    "title": "[Memory Adapter (built-in)](https://github.com/casbin/SwiftCasbin/blob/master/Sources/Casbin/Adapter/MemoryAdapter.swift)",
  ...
  },
  {
    ...
    "description": "[PostgreSQL, SQLite, MySQL, MongoDB](https://docs.vapor.codes/4.0/fluent/overview/#drivers) are supported by [Fluent](https://github.com/vapor/fluent)",
    "image": "/images/ecosystem/SQL.png",
    "tags": [
      "Swift",
      "Adapter"
  ...
  },
  {
    ...
    "description": "MySQL, PostgreSQL, SQLite3 are supported by [LuaSQL](http://lunarmodules.github.io/luasql/)",
    "image": "/images/ecosystem/SQL.png",
    "tags": [
      "Lua",
      "Adapter"
  ...
  },
  {
    ...
    "description": "A HTTP web framework featuring a Martini-like API with much better performance, via plugin: [authz](https://github.com/gin-contrib/authz) or [gin-casbin](https://github.com/maxwellhertz/gin-casbin)",
  ...
  },
  {
    ...
    "description": "An open-source, high-performance web framework for Go, via built-in plugin: [plugins/authz](https://github.com/astaxie/beego/blob/master/plugins/authz)",
  ...
  },
  {
    ...
    "description": "Fast, cross-platform HTTP/2 web server with automatic HTTPS, via plugin: [caddy-authz](https://github.com/casbin/caddy-authz)",
  ...
  },
  {
    ...
    "description": "The cloud native application proxy, via plugin: [casbin-forward-auth](https://github.com/grepplabs/casbin-forward-auth) or [traefik-auth-plugin](https://github.com/Knight-7/auth-plugin)",
  ...
  },
  {
    ...
    "description": "Your ultimate Go microservices framework for the cloud-native era, via plugin: [tx7do/kratos-casbin](https://github.com/tx7do/kratos-casbin) or [overstarry/kratos-casbin](https://github.com/overstarry/kratos-casbin)",
  ...
  },
  {
    ...
    "description": "A toolkit for microservices, via built-in plugin: [plugins/authz](https://github.com/go-kit/kit/tree/master/auth/casbin)",
  ...
  },
  {
    ...
    "description": "Fast HTTP package for Go. Tuned for high performance. Zero memory allocations in hot paths. Up to 10x faster than net/http, via plugin: [fasthttp-auth](https://github.com/casbin/fasthttp-auth)",
    "tags": [
      "Go",
      "Middleware"
    ]
  },
  {
    ...
    "description": "A high productivity, full-stack web framework for the Go language, via plugin: [auth/casbin](https://github.com/revel/modules/tree/master/auth/casbin)",
  ...
  },
  {
    ...
    "description": "High performance, minimalist Go web framework, via plugin: [echo-authz](https://github.com/labstack/echo-contrib/tree/master/casbin) or [echo-casbin](https://github.com/alexferl/echo-casbin) or [casbinrest](https://github.com/prongbang/casbinrest) or [echo-boilerplate](https://github.com/alexferl/echo-boilerplate)",
  ...
  },
  {
    ...
    "description": "The fastest web framework for Go in (THIS) Earth. HTTP/2 Ready-To-GO, via plugin: [casbin](https://github.com/iris-contrib/middleware/tree/master/casbin) or [iris-middleware-casbin](https://github.com/kokobing/iris-middleware-casbin)",
  ...
  },
  {
    ...
    "description": "A modular, powerful, high-performance and enterprise-class application development framework of Golang, via plugin: [gf-casbin](https://github.com/dobyte/gf-casbin)",
  ...
  },
  {
    ...
    "description": "A cloud-native Go microservices framework with cli tool for productivity, via plugin: [casbin in zero-contrib](https://github.com/zeromicro/zero-contrib/tree/main/auth/casbin)",
    "tags": [
      "Go",
      "Middleware"
    ]
  },
  {
    ...
    "description": "Idiomatic HTTP Middleware for Golang, via plugin: [negroni-authz](https://github.com/casbin/negroni-authz)",
    "tags": [
      "Go",
      "Middleware"
    ]
  },
  {
    ...
    "description": "A lightweight, idiomatic and composable router for building HTTP services, via plugin: [chi-authz](https://github.com/casbin/chi-authz)",
  ...
  },
  {
    ...
    "description": "A Go web development eco-system, designed to make your life easier, via plugin: [buffalo-mw-rbac](https://github.com/kgosse/buffalo-mw-rbac)",
  ...
  },
  {
    ...
    "description": "A high productive and modular web framework in Go, via plugin: [authz](https://github.com/go-macaron/authz)",
  ...
  },
  {
    ...
    "description": "Simple and easy go web micro framework, via plugin: [authz](https://github.com/devfeel/middleware/tree/master/authz)",
    "tags": [
      "Go",
      "Middleware"
    ]
  },
  {
    ...
    "description": "Micro & pluggable web framework for Go, via plugin: [authz](https://gitea.com/tango/authz)",
    "tags": [
      "Go",
      "Middleware"
    ]
  },
  {
    ...
    "description": "An express Go web framework with routing, middleware, dependency injection and http context, via plugin: [authz](https://github.com/baa-middleware/authz)",
    "tags": [
      "Go",
      "Middleware"
    ]
  },
  {
    ...
    "description": "An open source Enterprise API Gateway, supporting REST, GraphQL, TCP and gRPC protocols, via plugin: [tyk-authz](https://github.com/casbin/tyk-authz)",
    "tags": [
      "Go",
      "Middleware"
    ]
  },
  {
    ...
    "description": "Go HTTP framework with high-performance and strong-extensibility for building micro-services, via plugin: [casbin](https://github.com/hertz-contrib/casbin)",
  ...
  },
  {
    ...
    "description": "Fast, unopinionated, minimalist web framework for node, via plugin: [express-authz](https://github.com/node-casbin/express-authz)",
    "image": "/images/ecosystem/express.png",
    "tags": [
      "Node.js",
      "Middleware"
  ...
  },
  {
    ...
    "description": "Expressive middleware for node.js using ES2017 async functions, via plugin: [koa-authz](https://github.com/node-casbin/koa-authz) or [koajs-starter](https://github.com/djordjep/koajs-starter) or [koa-casbin](https://github.com/zcong1993/koa-casbin)",
  ...
  },
  {
    ...
    "description": "A highly extensible Node.js and TypeScript framework for building APIs and microservices, via plugin: [loopback4-authorization](https://github.com/sourcefuse/loopback4-authorization)",
  ...
  },
  {
    ...
    "description": "Progressive Node.js framework for building efficient and scalable server-side applications on top of TypeScript & JavaScript. via plugin: [nest-authz](https://github.com/dreamdevil00/nest-authz) or [nest-casbin](https://github.com/pardjs/nest-casbin) or [NestJS Casbin Module](https://github.com/switchit-conseil/nestjs-casbin-module) or [nestjs-casbin](https://github.com/juicycleff/nestjs-casbin) or [acl-nest](https://github.com/Twiddlle/acl-nest) or [nestjs-casbin-typeorm](https://github.com/0xb4lamx/nestjs-casbin-typeorm)",
  ...
  },
  {
    ...
    "description": "Fast and low overhead web framework, for Node.js. via plugin: [fastify-casbin](https://github.com/nearform/fastify-casbin) or [fastify-casbin-rest](https://github.com/nearform/fastify-casbin-rest)",
  ...
  },
  {
    ...
    "description": "Born to build better enterprise frameworks and apps with Node.js & Koa, via plugin: [egg-authz](https://github.com/node-casbin/egg-authz) or [egg-zrole](https://github.com/klren0312/egg-zrole)",
  ...
  },
  {
    ...
    "description": "The Simple, Secure Framework Developers Trust. via plugin: [hapi-authz](https://github.com/node-casbin/hapi-authz)",
  ...
  },
  {
    ...
    "description": "Authorization middleware that uses stateless JWT token to validate ACL rules using Casbin",
  ...
  },
  {
    ...
    "description": "Fast, lightweight, built on Web Standards. via plugin: [@hono/casbin](https://github.com/honojs/middleware/tree/main/packages/casbin)",
  ...
  },
  {
    ...
    "description": "A high-level Python Web framework, via plugin: [django-casbin](https://github.com/officialpycasbin/django-casbin) or [django-casbin-auth](https://github.com/officialpycasbin/django-casbin-auth)",
  ...
  },
  {
    ...
    "description": "A microframework for Python based on Werkzeug, Jinja 2 and good intentions, via plugin: [flask-authz](https://github.com/officialpycasbin/flask-authz) or [Flask-Casbin (3rd-party, but maybe more friendly)](https://github.com/daymien/Flask-Casbin) or [rbac-flask](https://github.com/daobeng/rbac-flask/tree/flask-casbin)",
  ...
  },
  {
    ...
    "description": "A modern, fast (high-performance), web framework for building APIs with Python 3.6+ based on standard Python type hints, via plugin: [fastapi-casbin-auth](https://github.com/officialpycasbin/fastapi-casbin-auth) or [Fastapi-app](https://github.com/lqmanh/fastapi-app)",
  ...
  },
  {
    ...
    "description": "The most widely deployed open source cloud software in the world, via plugin: [openstack-patron](https://github.com/casbin/openstack-patron)",
  ...
  },
  {
    ...
    "description": "Tornado is a Python web framework and asynchronous networking library, via plugin: [tornado-authz](https://github.com/officialpycasbin/tornado-authz)",
  ...
  },
  {
    ...
    "description": "Makes it easy to create Spring-powered applications and services, via plugin: [casbin-spring-boot-starter](https://github.com/jcasbin/casbin-spring-boot-starter) or [Simple SpringBoot security demo with jCasbin](https://github.com/jveverka/spring-examples/tree/master/spring-jcasbin)",
  ...
  },
  {
    ...
    "description": "A powerful and easy-to-use Java security framework that performs authentication, authorization, cryptography, and session management, via plugin: [shiro-casbin](https://github.com/jcasbin/shiro-casbin) or [shiro-jcasbin-spring-boot-starter](https://github.com/mapleafgo/shiro-jcasbin-spring-boot-starter)",
  ...
  },
  {
    ...
    "description": "A simple, light, rapid, independent and extensible Java WEB + ORM framework, via plugin: [jfinal-authz](https://github.com/jcasbin/jfinal-authz)",
    "tags": [
      "Java",
      "Middleware"
    ]
  },
  {
    ...
    "description": "Web framework (MVC/IOC/AOP/DAO/JSON) for all Java developers, via plugin: [nutz-authz](https://github.com/jcasbin/nutz-authz)",
  ...
  },
  {
    ...
    "description": "An intuitive, lightweight, high performance full stack Java web framework, via built-in plugin: [AuthorizationService.java](https://github.com/svenkubiak/mangooio/blob/e8c647a3f7c427bce27377025bec074f6d767f50/mangooio-core/src/main/java/io/mangoo/services/AuthorizationService.java)",
    "tags": [
      "Java",
      "Middleware"
    ]
  },
  {
    ...
    "description": "The PHP framework for web artisans, via plugin: [laravel-authz](https://github.com/php-casbin/laravel-authz)",
  ...
  },
  {
    ...
    "description": "A fast, secure, and efficient PHP framework, via plugin: [yii-permission](https://github.com/php-casbin/yii-permission) or [yii-casbin](https://github.com/php-casbin/yii-casbin)",
  ...
  },
  {
    ...
    "description": "Build fast, grow solid PHP Framework, via plugin: [cake-permission](https://github.com/php-casbin/cake-permission)",
  ...
  },
  {
    ...
    "description": "Associate users with roles and permissions in CodeIgniter4 Web Framework, via plugin: [CodeIgniter Permission](https://github.com/php-casbin/codeigniter-permission)",
  ...
  },
  {
    ...
    "description": "The ThinkPHP 5.1 framework, via plugin: [think-casbin](https://github.com/php-casbin/think-casbin)",
  ...
  },
  {
    ...
    "description": "The ThinkPHP 6.0 framework, via plugin: [think-authz](https://github.com/php-casbin/think-authz)",
    "image": "/images/ecosystem/thinkPHP.png",
    "tags": [
      "Php",
      "Middleware"
  ...
  },
  {
    ...
    "description": "The Symfony PHP framework, via plugin: [symfony-permission](https://github.com/php-casbin/symfony-permission) or [symfony-casbin](https://github.com/videni/symfony-casbin)",
  ...
  },
  {
    ...
    "description": "A coroutine framework that focuses on hyperspeed and flexibility, via plugin: [hyperf-permission](https://github.com/php-casbin/hyperf-permission) or [donjan-deng/hyperf-casbin](https://github.com/donjan-deng/hyperf-casbin) or [cblink/hyperf-casbin](https://github.com/cblink/hyperf-casbin)",
    "tags": [
      "Php",
      "Middleware"
    ]
  },
  {
    ...
    "description": "A distributed, persistent memory PHP framework based on the Swoole extension, via plugin: [easyswoole-permission](https://github.com/php-casbin/easyswoole-permission) or [easyswoole-hyperfOrm-permission](https://github.com/ice-leng/easyswoole-hyperfOrm-permission)",
    "tags": [
      "Php",
      "Middleware"
    ]
  },
  {
    ...
    "description": "A PHP micro framework that helps you quickly write simple yet powerful web applications and APIs, via plugin: [casbin-with-slim](https://github.com/php-casbin/casbin-with-slim)",
    "tags": [
      "Php",
      "Middleware"
    ]
  },
  {
    ...
    "description": "A full-stack PHP framework delivered as a C-extension, via plugin: [phalcon-permission](https://github.com/php-casbin/phalcon-permission)",
  ...
  },
  {
    ...
    "description": "High performance HTTP Service Framework for PHP based on Workerman, via plugin: [webman-permission](https://github.com/php-casbin/webman-permission) or [webman-casbin](https://github.com/sunsgneayo/webman-casbin)",
    "tags": [
      "Php",
      "Middleware"
    ]
  },
  {
    ...
    "description": "An open-source and cross-platform framework for building modern cloud based internet connected applications, such as web apps, IoT apps and mobile backends, via plugin: [Casbin.AspNetCore](https://github.com/casbin-net/Casbin.AspNetCore)",
  ...
  {
    "title": "[ASP.NET Core](https://docs.microsoft.com/en-us/aspnet/core)",
    "description": "A simple demo of using Casbin at ASP.NET Core framework, via plugin: [CasbinACL-aspNetCore](https://github.com/MustafaMustafayev/CasbinACL-aspNetCore)",
    "image": "/images/ecosystem/asp.jpeg",
    "tags": [
      ".NET",
      "Middleware"
  ...
  },
  {
    ...
    "description": "A Rust actors framework, via plugin: [actix-casbin](https://github.com/casbin-rs/actix-casbin)",
  ...
  },
  {
    ...
    "description": "A small, pragmatic, and extremely fast rust web framework, via plugin: [actix-casbin-auth](https://github.com/casbin-rs/actix-casbin-auth)",
    "image": "/images/ecosystem/actix.png",
    "tags": [
      "Rust",
      "Middleware"
  ...
  },
  {
    ...
    "description": "a web framework for Rust that makes it simple to write fast, secure web applications without sacrificing flexibility, usability, or type safety, via plugin: [rocket-authz](https://github.com/casbin-rs/rocket-authz) or [rocket-casbin-auth](https://github.com/0xethsign/rocket-casbin-auth-app)",
  ...
  },
  {
    ...
    "description": "A ergonomic and modular rust web framework, via plugin: [axum-casbin-auth](https://github.com/casbin-rs/axum-casbin-auth)",
    "tags": [
      "Rust",
      "Middleware"
    ]
  },
  {
    ...
    "description": "A full-featured and easy to use web framework with the Rust programming language, via plugin: [poem-casbin](https://github.com/casbin-rs/poem-casbin)",
  ...
  },
  {
    ...
    "description": "A server-side Swift web framework, via plugin: [vapor-authz](https://github.com/SwiftCasbin/vapor-authz)",
  ...
  },
  {
    ...
    "description": "A dynamic web platform based on NGINX and LuaJIT, via plugin: [lua-resty-casbin](https://github.com/casbin-lua/lua-resty-casbin) and [casbin-openresty-example](https://github.com/rushitote/casbin-openresty-example)",
  ...
  },
  {
    ...
    "description": "A cloud-native, platform-agnostic, scalable API Gateway distinguished for its high performance and extensibility via plugins, via plugin: [kong-authz](https://github.com/casbin-lua/kong-authz)",
    "image": "/images/ecosystem/openResty.png",
    "tags": [
      "Lua",
      "Middleware"
  ...
  },
  {
    ...
    "description": "A dynamic, real-time, high-performance API gateway, via plugin: [authz-casbin](https://github.com/apache/apisix/blob/master/docs/en/latest/plugins/authz-casbin.md)",
  ...
  },
  {
    ...
    "description": "A HTTP and reverse proxy server, a mail proxy server, and a generic TCP/UDP proxy server, via plugin: [nginx-casbin-module](https://github.com/casbin-cpp/nginx-casbin-module)",
  ...
  {
    "title": "[NATS, RabbitMQ, GCP Pub/Sub, AWS SNS & SQS, Kafka, InMemory](https://github.com/rusenask/casbin-go-cloud-watcher)",
    "description": "Watcher based on [Go Cloud Dev Kit](https://gocloud.dev/) that works with leading cloud providers and self-hosted infrastructure",
    "tags": [
      "Go",
      "Watcher"
    ],
  ...
  {
    "title": "[NATS, RabbitMQ, GCP Pub/Sub, AWS SNS & SQS, Kafka, InMemory](https://github.com/bartventer/casbin-go-cloud-watcher)",
    "description": "WatcherEx based on [Go Cloud Dev Kit](https://gocloud.dev/) that works with leading cloud providers and self-hosted infrastructure",
    "tags": [
      "Go",
      "Watcher"
    ],
  ...
  {
    "title": "[MongoDB Change Streams Watcher](https://github.com/node-casbin/mongo-changestream-watcher)",
    "description": "Watcher for [MongoDB Change Streams](https://www.mongodb.com/docs/manual/changeStreams/)",
    "image": "/images/ecosystem/monogoDB.png",
    "tags": [
      "Node.js",
      "Watcher"
  ...
  {
    "title": "[Default Role Manager (built-in)](https://github.com/casbin/casbin/blob/master/rbac/default-role-manager/role_manager.go)",
  ...
  },
  {
    ...
    "description": "Supports role hierarchy stored in the Casbin policy, with time-range-based sessions",
  ...
  },
  {
    ...
    "description": "Supports role hierarchy stored in [Auth0](https://auth0.com/)'s [Authorization Extension](https://auth0.com/docs/extensions/authorization-extension/v2)",
  ...
  {
    "title": "[Default Role Manager (built-in)](https://github.com/casbin/node-casbin/blob/master/src/rbac/defaultRoleManager.ts)",
    "description": "Supports role hierarchy stored in the Casbin policy",
    "tags": [
      "Node.js",
      "RoleManager"
  ...
  {
    "title": "[Default Role Manager (built-in)](https://github.com/casbin/pycasbin/blob/master/casbin/rbac/default_role_manager/role_manager.py)",
    "description": "Supports role hierarchy stored in the Casbin policy",
    "tags": [
      "Python",
      "RoleManager"
  ...
  {
    "title": "[Default Role Manager (built-in)](https://github.com/casbin/jcasbin/blob/master/src/main/java/org/casbin/jcasbin/rbac/DefaultRoleManager.java)",
    "description": "Supports role hierarchy stored in the Casbin policy",
    "tags": [
      "Java",
      "RoleManager"
  ...
  {
    "title": "[Default Role Manager (built-in)](https://github.com/php-casbin/php-casbin/blob/master/src/Rbac/DefaultRoleManager/RoleManager.php)",
    "description": "Supports role hierarchy stored in the Casbin policy",
    "tags": [
      "Php",
      "RoleManager"
