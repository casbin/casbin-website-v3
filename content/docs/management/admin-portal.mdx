...
<Image src="/images/docs/ui_model_editor.png" alt="model editor" width={800} height={600} />

<Image src="/images/docs/ui_policy_editor.png" alt="policy editor" width={800} height={600} />
...
<Tabs groupId="langs" items={['Go', 'Java', 'Node.js', 'Python', 'PHP']} persist>
<Tab value="Go">
